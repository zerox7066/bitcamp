...
<c:if test="${not empty board}">
        ...
        <div class='col-sm-10'>
        <input class='form-control' readonly id='regdate' type='date' name='regdate' value='${board.regDate}'>
        </div>
        </div>
        ...
        <div class='col-sm-10'>
        <input class='form-control' readonly id='viewcount' type='number' name='viewcount' value='${board.viewCount}'>
        </div>
        </div>
